...
We were given a set of 20 features in the full dataset of over 41k samples (records).  Some features related to the client and past interaction with the client.  Some related to macro-economic factors likely to affect the clients decsion.  (See the variable description list in the junyper notebook)
