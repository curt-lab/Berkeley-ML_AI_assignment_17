...
The technical problem to be solved was to compare multiple classification models to solve a business problem.  The models to be compared were Logistic Regression,
